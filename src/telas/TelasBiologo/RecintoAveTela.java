...
// Tela para criação e edição do recinto de aves

/**
 *
 * @author Vinicius
 */
public class RecintoAveTela extends javax.swing.JFrame {
    GerenciadorArquivos arquivo;
    boolean editor = false;
    RecintoAve recintoEscolhido;
    ...
    public RecintoAveTela(GerenciadorArquivos arquivo, Biologo biologoCriador) {
        initComponents();
    ...
    public RecintoAveTela(GerenciadorArquivos arquivo, RecintoAve recintoEscolhido) {
        initComponents();
        ...
        txtVolume.setText(String.valueOf(recintoEscolhido.getVolumeAviario()));
    ...
    private void initComponents() {
        ...
        txtVolume.setText("Volume do aviário");
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createSequentialGroup()
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(txtVolume, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtVolumeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtVolumeFocusGained
        if(txtVolume.getText().equals("Volume do aviário")) {
            txtVolume.setText("");
            txtVolume.setForeground(new Color(0,0,0));
        }
    ...
    private void btnConfAnimalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfAnimalActionPerformed
        if (txtFamilia.getText().equals("Família do recinto") || txtVegetacao.getText().equals("Tipo de vegetação") || 
                txtVolume.getText().equals("Volume do aviário")) 
            {
                ...
                if (editor) {
                    ...
                    RecintoAve recintoAveCriado = new RecintoAve(jrPoleiro.isSelected(), Double.parseDouble(txtVolume.getText()),
                                                          txtVegetacao.getText(), jrDiurno.isSelected(), animais, txtFamilia.getText(), biologos);
                    biologoCriador.adicionarIdRecinto(recintoAveCriado.getRecintoId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecintoAveTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecintoAveTela().setVisible(true);
            }
        });
    }
