...
// Tela para criação e edição do recinto de mamíferos
...
public class RecintoMamiferoTela extends javax.swing.JFrame {
    ...
    public RecintoMamiferoTela(GerenciadorArquivos arquivo, Biologo biologoCriador) {
        initComponents();
    ...
    private void btnConfAnimalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfAnimalActionPerformed
        if (txtFamilia.getText().equals("Família do recinto") || txtVegetacao.getText().equals("Tipo de vegetação") || txtArea.getText().equals("Área total")) 
            ...
            if (editor) {
                ...
                biologoCriador.adicionarIdRecinto(recintoMamCriado.getRecintoId());
